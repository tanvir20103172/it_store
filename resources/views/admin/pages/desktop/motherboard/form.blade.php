...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Add Motherboard</div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('motherboard.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input required name="chipset" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('chipset')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input required name="socket_supported" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                            ...
                            <div class="form-group">
                                ...
                                <input required name="memory_slot" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('memory_slot')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input required name="memory_max" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('memory_max')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror

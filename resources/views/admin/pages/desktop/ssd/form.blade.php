...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Add SSD</div>
                    ...
                    <div class="card-body">
                        <form action="{{route('ssd.store')}}"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Read Speed(Max)</label>
                                <input required name="read_speed" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('read_speed')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Write Speed(Max)</label>
                                <input required name="write_speed" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('write_speed')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror

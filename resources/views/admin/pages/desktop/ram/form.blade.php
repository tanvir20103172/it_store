                    ...
                    <div class="card-body">
                        <form action="{{ route('ram.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input required name="capacity" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('capacity')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input required name="ram_type" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('ram_type')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Bus Type</label>
                                <input required name="bus_speed" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('bus_speed')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Number of Pins</label>
                                <input required name="number_of_pin" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('number_of_pin')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">LED Lighting</label>
                                <input required name="led_lighting" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('led_lighting')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror

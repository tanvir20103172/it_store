...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Add Graphics</div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('graphics.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input required name="capcity" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('capcity')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">VGA Port</label>
                                <input required name="vga_port" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('vga_port')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Multi Display Capability</label>
                                <input required name="multi_display_capability" type="text" class="form-control"
                                    id="exampleFormControlInput1" placeholder="">
                                @error('multi_display_capability')
                                    <div class ="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
